#
#  Be sure to run `pod spec lint UIInsetsLabel.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/relayon/UIInsetsLabel.git", :tag => "1.0.0" }
  ...
  s.source_files  = "UIInsetsLabel/*.{h,m}"
